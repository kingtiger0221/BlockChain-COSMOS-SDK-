...
func RegisterCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgCreatePop{}, "ibcdex/CreatePop", nil)
	cdc.RegisterConcrete(&MsgUpdatePop{}, "ibcdex/UpdatePop", nil)
	cdc.RegisterConcrete(&MsgDeletePop{}, "ibcdex/DeletePop", nil)
