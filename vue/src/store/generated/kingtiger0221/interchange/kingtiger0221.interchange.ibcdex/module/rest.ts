...
export interface IbcdexMsgCreatePopResponse {
  /** @format uint64 */
  id?: string;
}

export type IbcdexMsgDeletePopResponse = object;
...
export type IbcdexMsgUpdatePopResponse = object;
...
export interface IbcdexQueryAllPopResponse {
  Pop?: IbcdexPop[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/kingtiger0221/interchange/ibcdex/buyOrderBook
   */
  queryBuyOrderBookAll = (
    ...
    this.request<IbcdexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/buyOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kingtiger0221/interchange/ibcdex/buyOrderBook/{index}
   */
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/buyOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/kingtiger0221/interchange/ibcdex/denomTrace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<IbcdexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/denomTrace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryDenomTrace = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetDenomTraceResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/denomTrace/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryOrderAll = (
    ...
    this.request<IbcdexQueryAllOrderResponse, RpcStatus>({
  ...
  queryOrder = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetOrderResponse, RpcStatus>({
  ...
  queryPopAll = (
    ...
    this.request<IbcdexQueryAllPopResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/pop`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryPop
   * @summary Queries a pop by id.
   * @request GET:/kingtiger0221/interchange/ibcdex/pop/{id}
   */
  queryPop = (id: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetPopResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/pop/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/kingtiger0221/interchange/ibcdex/sellOrderBook
   */
  querySellOrderBookAll = (
    ...
    this.request<IbcdexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/sellOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kingtiger0221/interchange/ibcdex/sellOrderBook/{index}
   */
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<IbcdexQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/kingtiger0221/interchange/ibcdex/sellOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
